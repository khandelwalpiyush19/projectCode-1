...
const Profile = () => {
    ...
    const { data: userData, loading, error } = useFetch(`${getEnv('VITE_API_BASE_URL')}/profile/get-user/${user.user._id}`,
    ...
    async function onSubmit(values) {
        try {
            ...
            const response = await fetch(`${getEnv('VITE_API_BASE_URL')}/profile/update-user/${userData.user._id}`, {
                method: 'put',
                credentials: 'include',
                body: formData
            })
